# Generated by Django 3.1.2 on 2022-02-14 12:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('piecejointe', models.FileField(blank=True, help_text='Importez un Document au format: <em>PDF, WORD ou EXCEL.</em>', null=True, upload_to='PDF/UE/', validators=[barbillard.validators.validate_file_extension], verbose_name='Syllabus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pole', models.ManyToManyField(blank=True, db_table='Enseignant_Poles', to='barbillard.TB_Pole', verbose_name='Ses Pôles')),
                ('ue', models.ManyToManyField(blank=True, db_table='Enseignement', to='barbillard.TB_Ue', verbose_name='UEs enseignées')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='barbillard.tb_article')),
            ],
            options={
                'ordering': ['-date_added'],
            },
